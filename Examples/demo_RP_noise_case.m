...
%since this example is a noise case, we use larger opts.rel_out_obj_tol
...
opts.rel_out_obj_diff_tol = 0.0001; 
...
legend('RP','LRGeomCG (1.25r)','LRGeomCG (rank by RP)', 'Location','NE')
axis([0 50 0 1])
grid
box on
set(gca,'FontSize',16); 
